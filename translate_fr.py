...
from seq2seq.data.dataset_translate import Seq2SeqDataset, BatchSampler
...
def get_args():
    ...
    parser.add_argument('--batch-size', default=1, type=int, help='maximum number of sentences in a batch') # Change default batch size to 128
